...
class _MeziState extends State<Mezi> {
  ...
  void handleFlower() async{
    ...
    handleSubmitted("وردة");
  }
  void handleKiss() async{
    if (kDebugMode) {
      print("kiss");
    }
    handleSubmitted("قبلة");
  }
                  ...
                  children: <Widget>[
                    Flexible(
                      child: TextField(
                        ...
                        decoration: const InputDecoration.collapsed(hintText: "اكتب رسالة ❤️..."),
                      ),
                    ),
                    Container(
